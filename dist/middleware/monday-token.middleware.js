...
exports.MondayTokenMiddleware = void 0;
const common_1 = require("@nestjs/common");
const monday_constants_1 = require("../monday.constants");
let MondayTokenMiddleware = exports.MondayTokenMiddleware = class MondayTokenMiddleware {
    constructor(mondaySdk) {
        this.mondaySdk = mondaySdk;
    }
    use(req, _, next) {
...
exports.MondayTokenMiddleware = MondayTokenMiddleware = __decorate([
